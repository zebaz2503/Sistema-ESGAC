...
<html lang="en">
    ...
    <head>
        ...
        <link href="{{ asset('/master_admin/global/css/plugins-md.min.css') }}" rel="stylesheet" type="text/css" />
        <!-- END THEME GLOBAL STYLES -->
        <!-- BEGIN PAGE LEVEL STYLES -->
        <link href="{{ asset('/master_admin/pages/css/error.min.css') }}" rel="stylesheet" type="text/css" />
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-container-bg-solid page-md">
        ...
        <div class="page-header navbar navbar-fixed-top">
            ...
            <div class="page-header-inner ">
                ...
                <div class="page-logo">
                    <a href="index.html">
                        <img src="{{ asset('/master_admin/layouts/layout2/img/logo-default.png') }}" alt="logo" class="logo-default" /> </a>
                    ...
                    <div class="top-menu">
                        <ul class="nav navbar-nav pull-right">
                                    ...
                                    <li>
                                        <ul class="dropdown-menu-list scroller" style="height: 275px;" data-handle-color="#637283">
                                            <li>
                                                <a href="#">
                                                    <span class="photo">
                                                        <img src="{{ asset('/master_admin/layouts/layout3/img/avatar2.jpg') }}" class="img-circle" alt=""> </span>
                                                    <span class="subject">
                                            ...
                                            <li>
                                                <a href="#">
                                                    <span class="photo">
                                                        <img src="{{ asset('/master_admin/layouts/layout3/img/avatar3.jpg') }}" class="img-circle" alt=""> </span>
                                                    <span class="subject">
                                            ...
                                            <li>
                                                <a href="#">
                                                    <span class="photo">
                                                        <img src="{{ asset('/master_admin/layouts/layout3/img/avatar1.jpg') }}" class="img-circle" alt=""> </span>
                                                    <span class="subject">
                            ...
                            <li class="dropdown dropdown-user">
                                <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                                    <img alt="" class="img-circle" src="{{ asset('/master_admin/layouts/layout2/img/avatar3_small.jpg') }}" />
...
<!------------------------------------------------->
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <div> 
                    @yield('content')
                    <!-- tener presente que este espacio es provicional-->
                    </div>
                </div>
                <!-- END CONTENT BODY -->
            </div>
                            ...
                            <div class="page-quick-sidebar-chat-users" data-rail-color="#ddd" data-wrapper-class="page-quick-sidebar-list">
                                ...
                                <ul class="media-list list-items">
                                    <li class="media">
                                        ...
                                        <img class="media-object" src="{{ asset('/master_admin/layouts/layout/img/avatar3.jpg') }}" alt="...">
                                    ...
                                    <li class="media">
                                        <img class="media-object" src="{{ asset('/master_admin/layouts/layout/img/avatar1.jpg') }}" alt="...">
                                        <div class="media-body">
                                    ...
                                    <li class="media">
                                        ...
                                        <img class="media-object" src="{{ asset('/master_admin/layouts/layout/img/avatar4.jpg') }}" alt="...">
                                        <div class="media-body">
                                    ...
                                    <li class="media">
                                        <img class="media-object" src="{{ asset('/master_admin/layouts/layout/img/avatar2.jpg') }}" alt="...">
                                        <div class="media-body">
                                ...
                                <ul class="media-list list-items">
                                    <li class="media">
                                        ...
                                        <img class="media-object" src="{{ asset('/master_admin/layouts/layout/img/avatar6.jpg') }}" alt="...">
                                        <div class="media-body">
                                    ...
                                    <li class="media">
                                        ...
                                        <img class="media-object" src="{{ asset('/master_admin/layouts/layout/img/avatar7.jpg') }}" alt="...">
                                        <div class="media-body">
                                    ...
                                    <li class="media">
                                        <img class="media-object" src="{{ asset('/master_admin/layouts/layout/img/avatar8.jpg') }}" alt="...">
                                        <div class="media-body">
                                    ...
                                    <li class="media">
                                        ...
                                        <img class="media-object" src="{{ asset('/master_admin/layouts/layout/img/avatar9.jpg') }}" alt="...">
                                        <div class="media-body">
                                    ...
                                    <li class="media">
                                        <img class="media-object" src="{{ asset('/master_admin/layouts/layout/img/avatar10.jpg') }}" alt="...">
                                        <div class="media-body">
                                    ...
                                    <li class="media">
                                        ...
                                        <img class="media-object" src="{{ asset('/master_admin/layouts/layout/img/avatar11.jpg') }}" alt="...">
                                        <div class="media-body">
                            ...
                            <div class="page-quick-sidebar-item">
                                <div class="page-quick-sidebar-chat-user">
                                    ...
                                    <div class="page-quick-sidebar-chat-user-messages">
                                        <div class="post out">
                                            <img class="avatar" alt="" src="{{ asset('/master_admin/layouts/layout/img/avatar3.jpg') }}" />
                                            <div class="message">
                                                <span class="arrow"></span>
                                        ...
                                        <div class="post in">
                                            <img class="avatar" alt="" src="{{ asset('/master_admin/layouts/layout/img/avatar2.jpg') }}" />
                                            <div class="message">
                                                <span class="arrow"></span>
        ...
        <div class="page-footer">
            ...
            <!-- END QUICK NAV -->
            <!--[if lt IE 9]>
<script src="../master_admin/global/plugins/respond.min.js"></script>
<script src="../master_admin/global/plugins/excanvas.min.js"></script> 
<script src="../master_admin/global/plugins/ie8.fix.min.js"></script> 
<![endif]-->
            <!-- BEGIN CORE PLUGINS -->
            <script src="{{ asset('/master_admin/global/plugins/jquery.min.js') }}" type="text/javascript"></script>
            <script src="{{ asset('/master_admin/global/plugins/bootstrap/js/bootstrap.min.js') }}" type="text/javascript"></script>
            <script src="{{ asset('/master_admin/global/plugins/js.cookie.min.js') }}" type="text/javascript"></script>
            <script src="{{ asset('/master_admin/global/plugins/jquery-slimscroll/jquery.slimscroll.min.js') }}" type="text/javascript"></script>
            <script src="{{ asset('/master_admin/global/plugins/jquery.blockui.min.js') }}" type="text/javascript"></script>
            <script src="{{ asset('/master_admin/global/plugins/bootstrap-switch/js/bootstrap-switch.min.js') }}" type="text/javascript"></script>
            <!-- END CORE PLUGINS -->
            <!-- BEGIN THEME GLOBAL SCRIPTS -->
            <script src="{{ asset('/master_admin/global/scripts/app.min.js') }}" type="text/javascript"></script>
            <!-- END THEME GLOBAL SCRIPTS -->
            <!-- BEGIN THEME LAYOUT SCRIPTS -->
            <script src="{{ asset('/master_admin/layouts/layout2/scripts/layout.min.js') }}" type="text/javascript"></script>
